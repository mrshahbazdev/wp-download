# WP Downloader – Download WordPress Themes & Plugins as ZIP

WP Downloader is a lightweight, secure WordPress admin tool that lets you download any installed theme or plugin as a ZIP file directly from the dashboard. It is perfect for backups, migrations, offline development, or sharing a custom build with clients.
...
Whether you need to back up an installed theme, clone a plugin to another site, or archive your work before an update, WP Downloader makes it fast. No FTP, no cPanel, and no command line required.
...
1. From the WordPress admin menu, go to **Tools → WP Downloader**.
...
Only administrators (users with the `manage_options` capability) can access the WP Downloader page.
...
WP Downloader is free software released under the [GNU General Public License v2.0 or later](https://www.gnu.org/licenses/gpl-2.0.html).
